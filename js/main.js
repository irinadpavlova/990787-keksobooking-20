...
var createAddCard = function (object) {
...
// Открытие карточки объявления по клику на метку
...
var renderTargetCard = function (cardTargetIndex) {
  ...
  fragmentForCardTmp.appendChild(createAddCard(addObjects[cardTargetIndex]));
